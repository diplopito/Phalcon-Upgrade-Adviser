...
class Phalcon3to4
{
    ...
    const CLASSES_V4 = [
            "Phalcon\Acl\Component" => "New",
            "Phalcon\Acl\Enum" => "New",
            "Phalcon\Annotations\Adapter\AbstractAdapter" => "New",
            "Phalcon\Annotations\Adapter\Stream" => "New",
            "Phalcon\Annotations\AnnotationsFactory" => "New",
            "Phalcon\Application\AbstractApplication" => "New",
            "Phalcon\Assets\Asset" => "New",
            "Phalcon\Assets\Asset\Css" => "New",
            "Phalcon\Assets\Asset\Js" => "New",
            "Phalcon\Cache" => "New",
            "Phalcon\Cache\AdapterFactory" => "New",
            "Phalcon\Cache\Adapter\Apcu" => "New",
            "Phalcon\Cache\Adapter\Libmemcached" => "New",
            "Phalcon\Cache\Adapter\Memory" => "New",
            "Phalcon\Cache\Adapter\Redis" => "New",
            "Phalcon\Cache\Adapter\Stream" => "New",
            "Phalcon\Cache" => "New",
            ...
            "Phalcon\Config\ConfigFactory" => "New",
            "Phalcon\Container" => "New",
            "Phalcon\Db\AbstractDb" => "New",
            "Phalcon\Db\Adapter\AbstractAdapter" => "New",
            "Phalcon\Db\Adapter\Pdo\AbstractPdo" => "New",
            "Phalcon\Db\Enum" => "New",
            "Phalcon\Dispatcher\AbstractDispatcher" => "New",
            ...
            "Phalcon\Factory\AbstractFactory" => "New",
            ...
            "Phalcon\Flash\AbstractFlash" => "New",
            "Phalcon\Forms\Element\AbstractElement" => "New",
            ...
            "Phalcon\Html\Link\EvolvableLink" => "New",
            "Phalcon\Html\Link\EvolvableLinkProvider" => "New",
            "Phalcon\Html\Link\Link" => "New",
            "Phalcon\Html\Link\LinkProvider" => "New",
            "Phalcon\Html\Link\Serializer\Header" => "New",
            ...
            "Phalcon\Image\ImageFactory" => "New",
            "Phalcon\Logger\AdapterFactory" => "New",
            "Phalcon\Logger\Adapter\AbstractAdapter" => "New",    
            "Phalcon\Logger\Adapter\Noop" => "New",
            "Phalcon\Logger\Formatter\AbstractFormatter" => "New",
            "Phalcon\Messages\Exception" => "New",
            "Phalcon\Messages\Message" => "New",
            "Phalcon\Messages\Messages" => "New",
            "Phalcon\Mvc\Model\MetaData\Stream" => "New",
            "Phalcon\Mvc\View\Engine\AbstractEngine" => "New",
            "Phalcon\Paginator\Adapter\AbstractAdapter" => "New",
            "Phalcon\Paginator\PaginatorFactory" => "New",
            "Phalcon\Paginator\Repository" => "New",
            "Phalcon\Session\Adapter\AbstractAdapter" => "New",
            "Phalcon\Session\Adapter\Noop" => "New",
            "Phalcon\Session\Adapter\Stream" => "New",
            "Phalcon\Session\Manager" => "New",
            ...
            "Phalcon\Translate\Adapter\AbstractAdapter" => "New",
            "Phalcon\Translate\InterpolatorFactory" => "New",
            "Phalcon\Translate\TranslateFactory" => "New",
            "Phalcon\Url" => "New",
            "Phalcon\Url\Exception" => "New",
            "Phalcon\Validation\AbstractCombinedFieldsValidator" => "New",
            "Phalcon\Validation\AbstractValidatorComposite" => "New",
            "Phalcon\Validation\ValidatorFactory" => "New",
            ...
            "Phalcon\Validation\Validator\Ip" => "New",
